    ...
    <main class="mainPattern">
      <section id="left">
        ...
        <article id="jardins" class="box">
          ...
          <p>
            Quand certains trouvent des effets "positifs" à la colonisation, on ne peut que s'interroger face à la <strong>perte de tous les savoirs de ces populations</strong> que les colons
